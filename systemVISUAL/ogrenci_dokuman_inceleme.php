...
<head>
   ...
   <link rel="stylesheet" type="text/css" href="../systemTHEME/panel.css">
    ...
    <script language="javascript" type="text/javascript">
       ...
       window.onload = dokumanGoster;





       function dokumanGoster ()
       {
                       ...
                       if(ders['sgd']=='o')
                       {
                           document.getElementById('sinavs').remove();
                            ...
                            $.ajax({
                               type : 'POST',
                               url : '../systemPHP/ogrenciDersGoruntuleme.php',
                               data :  { cmd : 'otdg' , seviyeid : ders['seviyeid']  , did:dokid },
                               success : function (data)
                               {
                                	if (data!="")
                                	{
                                        dokuman = $.parseJSON(data);
                                        $('#dokis').html(dokuman['dadi']);
                                        wiewFile(dokuman['dosya']);
                                    }
                                }
                            });
                   }
                  ...
                  if(data=="")
                  {
                      ...
                      sdokumanlar = $.parseJSON(data);
                          for (var i = 0; i<= sdokumanlar.length -1; i++) {
                              yazi += "<div style='float:left;margin-top:10px;margin-left:10px;width:160px;padding:10px 10px 10px 10px;box-shadow:black 0px 0px 1px;border-radius:5px;'><img src='http://localhost/uzakademi.org/Graphics/svg/documenticn.png' style='width: 80%;height: 113px;margin-left: 10%;' /> <p style='font-family: Exo, sans-serif;text-align:center;margin-top: 16px;'>" + sdokumanlar[i]['dadi'] + "</p><a href='ogrenci_dokuman_inceleme.php?did=" + sdokumanlar[i]['did'] + "&dersid=" + drsid + "&dersadi=" + ders['dersadi'] + "'><div style='background: #27AE60;width: 100%;text-align: center;padding: 10px 0px 10px 0px;margin-top: 20px;border-radius: 2px;font-family: Open Sans, sans-serif;color: #ffffff;box-shadow: #000000 0px 0px 1px;' >Göster</div></a></div>";
                          }
...
margin-top: 8px;" ></a>
    ...
    <div  class="newLauncher">
        <div id="derb" style="background: #ffffff;" onclick="dok()" class="newLauncherLink">
            <img style="border-radius:100px;" src="../Graphics/svg/documenticn.png" />
            <p>Dosya</p>
        </div>
    ...
    <div style="width: 75%;margin-top: 58px;margin-left:139px;margin-bottom:100px;" class="panel_akis_tasiyici" id="at">
     ...
     <div id="dersbilust">
        <h1 id="dersh1" class="baslik" style="margin:0;margin-top:20px;margin-left: 0%;"> <h1>
     </div>
     ...
     <div id="dersbilgileri">
         ...
         <div id="dblg" style="width: 90%;height: auto;margin-top:10px;overflow: hidden;background: #ffffff;margin-left: 20px;box-shadow: #000000 0px 0px 1px;border-radius:0px;">
             <div style="width: 104%;margin-left:-2%;padding: 15px 0px 11px 0px;border-bottom: 1px solid #e5e5e5;background:#F6F7F8;">
                 <p id="dokis" onclick="" style="color: #048CAD; float:left;font-family: 'Exo', sans-serif;margin-left:20px;"></p>
                 <div style="margin: 0;position: static;padding: 0px 7px 0px 7px;margin-left: 85%;border:none;border-radius: 0px;text-shadow: none;margin-top: -8px;" class="soruonay">Tam Ekran</div>
             </div>
             <div id="icerik" style="width:100%;height:400px;background:black;">
             </div>
         </div>

  ...
  $('#login').toggle();
    ...
    <script type="text/javascript" language="javascript">
        ...
        function dokumanEkle (did,tid)
        {
            ...
            document.getElementById('eklenendokuman').innerHTML += "<div id='ekldok" + tid + "' style='width:100%;padding: 20px 0px 20px 0px;box-shadow:black 0px 0px 1px;'> <img src='../Graphics/svg/koleksiyon.fw.png' width='50' height='50' style='float: left;margin-top: -12px;' /> <p id='dis" + tid +"' style='margin-left:20px;float:left;'>" + ad + "</p> <a style='padding: 4px 10px 4px 10px;border: solid #e5e5e5 1px;border-radius: 15px;margin-left: 12%;color: black;text-decoration: none;' href='javascript:dokumanKaldir(" + tid + ");'> Kaldır </a> <input type='hidden' name='dokuman" + did + "' value='on'/> </div>";
        }
    ...
    <script language="javascript" type="text/javascript">
        ...
        var gsgd=null;
         ...
         function seviyeGecmeDurumu ()
         {
             ...
             {
                 alert("Önce Ders adını va açıklamasını girin! ");
             }
         }
        ...
        function dersOlustur()
        {
            $.ajax({
               type : 'POST',
               url : "../systemPHP/dersOlustur.php",
               ...
               success : function (data)
               {
                   ...
                   if(veri['durum']=="OK")
                   {
                       ...
                       $('#derse').click(
                           function ()
                           {
                               window.location="../systemVISUAL/ogretmen_ders_goruntuleme.php?dersid=" + veri['dersid'] + "&seviyeno=1&dersadi=" + $('#ad').val();
                           }
                       );
                   }
               }
...
<body style="background-color:#FAFAFA;overflow-y: hidden"  >
  ...
  <div class="newLauncher">
      ...
      <div id="dersad" class="newLauncherLink">
 ...
 <div id="tasiyici" style="transition: all 0.2s ease;  width: 90%;left: 9%; height: 550%; margin-top: 70px;position: absolute;" >
     ...
     <form id="ders" method="post">
         ...
         <h1 class="baslik" style="margin-top: 250px;width: 90%;left: 9%;text-align: center; font-family: 'Exo', sans-serif; color: #000000;">Dersinizin İlk Seviyesi Neye Bağlı Olarek Geçilecek</h1>
         ...
         <h1 class="baslik" style="margin-top: 220px;width: 90%;left: 9%;text-align: center; font-family: 'Exo', sans-serif; color: #000000;">Dersinizin İlk Seviyesinde Yayınlamak İçin Döküman Seçin</h1>
         ...
         <h1 id="sinbaslik" class="baslik" style="margin-top: 220px;width: 90%;left: 9%;text-align: center; font-family: 'Exo', sans-serif; color: #000000;">Dersinizin İlk Seviyesi İçin Sınav Oluşturun</h1>
         ...
         <h1 id="odbas" class="baslik" style="margin-top: 220px;width: 90%;left: 9%;text-align: center; font-family: 'Exo', sans-serif; color: #000000;">Dersinizin İlk Seviyesi İçin Ödev Verin</h1>
         ...
         <h1 class="baslik" style="margin-top: 466px;width: 90%;left: 9%;text-align: center; font-family: 'Exo', sans-serif; color: #000000;">Butona Tıklayın ve Dersiniz Oluşturulsun</h1>

         <div id="derse" style="margin-left: 35%; margin-top: 12px; text-align: center; width: 10%;padding: 10px 10px 10px 10px; background:#4B77BE; border-radius: 10px;box-shadow: #000000 0px 0px 1px;color: #ffffff;font-family: 'exo', sans-serif;font-size: 25px " onclick="dersOlustur()" >

             Sonraki
         </div>
         <input type="hidden" name="komut" value="do" >
